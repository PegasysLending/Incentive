 ...
 * @notice Distributor contract for rewards to the Pegasys protocol, using a staked token as rewards asset.
 * The contract stakes the rewards before redistributing them to the Pegasys protocol participants.
